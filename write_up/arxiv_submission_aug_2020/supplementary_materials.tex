...
\end{equation}
%
where $p_{ij}$ is the probability of transitioning from state $i\in\{1,2,3,4\}$ at time $n$ to state $j\in\{1,2,3,4\}$ at time $n+1$, and $X(0)=1$. The target distribution is, hence, the stationary distribution of this process.
